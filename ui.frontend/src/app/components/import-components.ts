 ...
 */
MapTo('aem_dialogs_angular/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('aem_dialogs_angular/components/separator')(SeparatorV1Component);

MapTo('aem_dialogs_angular/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('aem_dialogs_angular/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('aem_dialogs_angular/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('aem_dialogs_angular/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('aem_dialogs_angular/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('aem_dialogs_angular/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('aem_dialogs_angular/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('aem_dialogs_angular/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('aem_dialogs_angular/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('aem_dialogs_angular/components/accordion')(AccordionV1Component);
MapTo('aem_dialogs_angular/components/tabs')(TabsV1Component);
...
LazyMapTo('aem_dialogs_angular/components/teaser')(TeaserV1Component);
...
LazyMapTo('aem_dialogs_angular/components/carousel')(CarouselV1Component);
...
LazyMapTo('aem_dialogs_angular/components/text')(LazyTextModule, TextEditConfig);